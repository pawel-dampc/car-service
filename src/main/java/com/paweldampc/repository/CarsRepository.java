...
public class CarsRepository {
    ...
    private List<Car> importCars() {
        ...
        cars.add(new Car("GKA34521".toUpperCase(), "Audi Q8".toUpperCase(), "Złoty".toUpperCase(), 2021, LocalDate.now().minusDays(3), false));
        cars.add(new Car("GA12123".toUpperCase(), "Seat Toledo".toUpperCase(), "Srebrny".toUpperCase(), 2008, LocalDate.now().minusDays(2), true));
        cars.add(new Car("GD76562".toUpperCase(), "Honda Accord".toUpperCase(), "Czarny".toUpperCase(), 2016, LocalDate.now().minusDays(4), true));
        return cars;
    }
